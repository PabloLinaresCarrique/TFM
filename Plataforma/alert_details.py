...
from utils import get_db_connection  # Import utility function to get database connection
from enhanced_entity_graph import show_entity_graph  # Function to show the entity graph visualization
from narrative_component import show_narrative_tab  # Function to display and manage the narrative section
from osint_search import perform_osint_search  # Function to perform Open Source Intelligence (OSINT) search
from mongodb_case_management import (  # Import MongoDB case management functions
    create_case,
    get_case,
    update_narrative,
...
import base64  # Library used to encode file content for document uploads

# Function to display and manage the entities section
def show_entities_section(client_details):
    st.write("## Entities")

    # Initialize session state for entity tabs and additional info fields
    ...
    # Add a new entity tab dynamically
    ...
    # Loop through each entity tab and handle input fields
    for i, tab_name in enumerate(st.session_state.entity_tabs):
        with entity_tabs[i]:
            ...
            # Display client details for the main client, otherwise show blank inputs for new entities
            ...
            # Display additional info fields for each entity tab
            ...
            # Button to add additional info fields
            ...
            if st.button("Save Changes", key=f"save_changes_{tab_name}_{i}"):
                ...
                # Check for active case and update entity data in the case
...
# Function to display alert details and manage case review process
def show_alert_details(alert_id):
    ...
    # Tab 1: Alert overview and case review process
    with tab1:
        ...
        # Case closure options if the case is not closed
        if current_case and current_case.get('status') != 'closed':
            ...
            # Selectbox for case closure type
            ...
            # Button to resolve and close the case
        ...
        # Display alert details in two columns
        ...
        # Upload and attach documents to the case
        st.write("## Documents")
...
# Function to fetch alert details from the database
...
# Function to fetch client details using the account number
